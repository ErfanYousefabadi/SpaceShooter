...
public class GameOverScene : Scene
{
    ...
    private SpriteFont _fontSmall, _font, _fontBig;
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        Vector2 retrySize = _fontSmall.MeasureString(retry);
        Vector2 quitSize = _fontSmall.MeasureString(quit);
        ...
        Core.SpriteBatch.DrawString(_fontSmall, retry, retryPos + Vector2.One * 5, shadow);
        Core.SpriteBatch.DrawString(_fontSmall, retry, retryPos, Color.Gray);
        Core.SpriteBatch.DrawString(_fontSmall, quit, quitPos + Vector2.One * 5, shadow);
        Core.SpriteBatch.DrawString(_fontSmall, quit, quitPos, Color.Gray);
